...
public class ReplacedChickenEntity extends ReplacedEntityBase {
    private final RawAnimation FLAP = RawAnimation.begin().thenPlay("flap");
    private final RawAnimation SPRINT = RawAnimation.begin().thenPlay("sprint");
    private boolean inAir;

    public ReplacedChickenEntity(EntityType<?> type) {
        super(type);
    }
